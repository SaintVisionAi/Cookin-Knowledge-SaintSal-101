    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="flex pt-20">
        ...
        <div className="fixed left-0 top-20 bottom-0 w-80 bg-gray-900/50 backdrop-blur-sm border-r border-gray-800 p-6 overflow-y-auto">
          <div className="mb-6">
            <h2 className="text-lg font-bold text-[hsl(var(--gold))] mb-2">
              Table of Contents
            </h2>
              ...
              <div className="bg-gradient-to-r from-yellow-400/10 to-yellow-600/10 rounded-xl p-8 border border-yellow-400/30">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[hsl(var(--gold))] font-medium">
                ...
                <div className="space-y-8 text-gray-300 leading-relaxed">
                  <div>
                    ...
                    <p className="text-lg mb-4">
                      The Human-AI Connection Protocol (HACP™) is the core
                      adaptive intelligence framework that powers every Saint
                      Vision interface — from SaintSal's coaching flows to
                      immersive therapy apps, onboarding flows, PartnerTech
                      routing, and executive dashboards.
                    </p>
                    <p>
                      More than just a UX philosophy or prompting technique,
                      HACP is a structured, adaptive, real-time escalation
                      engine that tunes itself based on user ability, emotional
                      state, task complexity, and timing feedback loops.
                    </p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-black/30 rounded-lg p-6 border border-gray-700">
                      <h4 className="text-xl font-semibold text-[hsl(var(--gold))] mb-3">
                        Adaptive Response System
                      </h4>
                      <ul className="space-y-2 text-sm">
                        <li>
                          • Escalating prompts (hint → cue → example →
                          intervention)
                        </li>
                        <li>• Context-aware persona shifts</li>
                        <li>
                          • Multimodal inputs (gesture, text, gaze, sensor)
                        </li>
              ...
              <div className="bg-gray-900 rounded-xl p-8 border border-gray-800">
                ...
                <div className="space-y-8 text-gray-300 leading-relaxed">
                  <div className="bg-green-400/10 rounded-lg p-6 border border-green-400/30">
                    ...
                    <p className="text-lg">
                      Saint Vision Group LLC and its associated platforms
                      (SaintSal™, PartnerTech.ai, Athen.ai, EbyTech.ai,
                      SVTlegal.ai, SVTteach.ai) are committed to the highest
                      standards of privacy, data protection, and ethical
                      conduct.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <ul className="space-y-2">
                        ...
                        <li>
                          • Optional CRM, calendar, financial data you connect
                        </li>
                  ...
                  <div>
                    ...
                    <div className="bg-black/30 rounded-lg p-6 border border-gray-700">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          <strong className="text-white">Hosting:</strong> SOC
                          2-aligned stack
                        </div>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {[
                        ...
                        <div
                          key={compliance}
                          className="flex items-center gap-2 bg-green-400/20 px-3 py-1 rounded-full"
                        >
              ...
              <div className="bg-gray-900 rounded-xl p-8 border border-gray-800">
                ...
                <div className="space-y-8 text-gray-300 leading-relaxed">
                  <div>
                    ...
                    <p>
                      By using SaintVisionAI services, you agree to use our
                      platform responsibly and in accordance with applicable
                      laws and regulations. Our services are designed for
                      legitimate business purposes and professional
                      collaboration.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mb-4">
                      ...
                      Saint Vision Group LLC and are protected by international
                      copyright, trademark, and patent laws, including:
                    </p>
                  ...
                  <div>
                    ...
                    <p>
                      Saint Vision Group LLC shall not be liable for any
                      indirect, incidental, special, consequential, or punitive
                      damages resulting from your use of our services. Our total
                      liability is limited to the amount paid for services in
                ...
                <div className="space-y-8 text-gray-300 leading-relaxed">
                  <div className="bg-purple-400/10 rounded-lg p-6 border border-purple-400/30">
                    ...
                    <p className="text-lg italic">
                      "This isn't AI. This is assistance. Intelligent.
              ...
              <div className="bg-gray-900 rounded-xl p-8 border border-gray-800">
                ...
                <div className="space-y-8 text-gray-300 leading-relaxed">
                    ...
                    <div className="bg-orange-400/10 rounded-lg p-6 border border-orange-400/30">
                      <ul className="space-y-3">
                        <li>
                          •{" "}
                          <strong className="text-white">
                            Delaware LP IP Holding Structure:
                          </strong>{" "}
                          All patents held separately for risk isolation
                        </li>
                        <li>
                          •{" "}
                          <strong className="text-white">
                          ...
                          Day-to-day business operations with full licensing
                          control
                        </li>
                        <li>
                          •{" "}
                          ...
                          KYC + AML protocols for global operations
                        </li>
                        <li>
                          •{" "}
                          <strong className="text-white">
                          ...
                          Investor and user funds separated under compliance
                          firewall
                        </li>
                      </ul>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-black/30 rounded-lg p-6 border border-gray-700">
                        <h4 className="font-semibold text-[hsl(var(--gold))] mb-3">
                          Current Patents
                        </h4>
                        <ul className="space-y-2 text-sm">
                          <li>• U.S. Patent No. 10,290,222</li>
                          <li>
                            • Interactive Tutorial with Escalating Prompts
                          </li>
                          <li>• Issued: May 2019</li>
                  ...
                  <div>
                    ...
                    <p className="mb-4">
                      All operational tools are fully licensed and under Saint
                      Vision Group control:
                    </p>
                    <div className="flex flex-wrap gap-3">
                      {[
                        "GoHighLevel CRM",
              ...
              <div className="bg-gray-900 rounded-xl p-8 border border-gray-800">
                ...
                <div className="space-y-8 text-gray-300 leading-relaxed">
                  ...
                  <div>
                    ...
                    <p className="mb-6">
                      Our services comply with international data protection
                      regulations and industry standards to ensure your privacy
                      rights and business requirements are fully protected.
                    </p>
            ...
            >
              <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl p-8 border border-gray-700">
                ...
                <div className="space-y-6 text-gray-300">
                  <p className="text-lg">
                    For legal inquiries, privacy concerns, compliance questions,
                    or IP licensing opportunities, please contact our legal
                    team:
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-black/30 rounded-lg p-6 border border-gray-700">
                      ...
                      <div className="space-y-2">
                        <div className="text-[hsl(var(--gold))] font-medium">
                          legal@saintvisionai.com
                        </div>
                        <div className="text-sm text-gray-400">
                          Privacy, compliance, general legal matters
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-black/30 rounded-lg p-6 border border-gray-700">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="text-sm text-gray-400">
                          Patent licensing, IP partnerships
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-yellow-400/10 rounded-lg p-6 border border-yellow-400/30">
                    ...
                    <div className="space-y-1 text-sm">
                      <div>
                        <strong className="text-white">Entity:</strong> Saint
                        Vision Group LLC
                      </div>
                      <div>
                      ...
                      <div>
                        <strong className="text-white">Registration:</strong> IP
                        Holding Company + Operating LLC structure
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <footer className="border-t border-gray-800 pt-8 pb-16">
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-400 text-sm max-w-2xl mx-auto">
                  We protect your data. We respect your time. We serve your
                  purpose. Built with patent-protected technology and
