    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white">
      ...
      <div className="text-center py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            We're on a mission to ensure every website delivers perfect navigation experiences. 
            Powered by cutting-edge AI, we protect your users from broken routes and lost conversions.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 text-center">
        ...
        <p className="text-lg text-gray-300 leading-relaxed">
          Every broken link costs businesses money. Every 404 error frustrates users. Every slow route 
          hurts conversions. We built SaintVisionAI to solve these problems with advanced AI monitoring 
          that works 24/7, catching issues before they impact your business.
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-yellow-400/10 to-yellow-600/10 border-y border-yellow-400/20">
        <div className="max-w-4xl mx-auto text-center py-16 px-6">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Join hundreds of businesses using SaintVisionAI for bulletproof navigation
          </p>
          <Link to="/pricing">
