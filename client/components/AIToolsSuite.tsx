...
export function AIToolsSuite() {
  ...
  const [installedPackages, setInstalledPackages] = useState<string[]>(["starter"]);
  ...
  const selectedPkg = productivityPackages.find(pkg => pkg.id === selectedPackage);
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Complete toolkit for AI-powered workflows</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="text-right">
              <div className="text-sm font-semibold text-[hsl(var(--gold))]">Installed</div>
              <div className="text-xs text-gray-400">{installedPackages.length} packages</div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {productivityPackages.map((pkg) => {
                  ...
                  return (
                    ...
                    >
                      {/* Background Gradient */}
                      <div className={`absolute inset-0 bg-gradient-to-br ${pkg.color} opacity-0 group-hover:opacity-10 rounded-xl transition-opacity duration-300`}></div>
                      ...
                      <div className="relative">
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div className={`px-2 py-1 rounded text-xs font-medium ${
                              pkg.tier === 'Free' ? 'bg-green-900 text-green-300' :
                              pkg.tier === 'Premium' ? 'bg-[hsl(var(--gold))]/20 text-[hsl(var(--gold))]' :
                              pkg.tier === 'Professional' ? 'bg-purple-900 text-purple-300' :
                        ...
                        <div className="text-lg font-bold text-[hsl(var(--gold))] mb-2">{pkg.price}</div>
                        ...
                        >
                          {isInstalled ? (
                            ...
                            <>
                              ...
                              {pkg.tier === 'Free' ? 'Install Free' : 'Upgrade & Install'}
                            </>
                          )}
                        </Button>
                      </div>
              ...
              <>
                ...
                <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
                  <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
                    <selectedPkg.icon className={`w-5 h-5 ${selectedPkg.iconColor}`} />
                    {selectedPkg.name}
                  </h3>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="text-sm text-gray-400">{selectedPkg.description}</div>
                    </div>
                ...
                <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
                  ...
                  <div className="space-y-3">
                    {selectedPkg.tools.map((tool, index) => {
                      ...
                      const isInstalled = installedPackages.includes(selectedPkg.id);
                      return (
                        <div
                          key={index}
