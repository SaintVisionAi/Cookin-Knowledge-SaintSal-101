          ...
          <div className="flex flex-col lg:flex-row items-start justify-between gap-8">
            <div className="flex-1 max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Because your business deserves AI that actually makes sense —
            ...
            <div className="grid grid-cols-2 gap-4 lg:gap-6 min-w-[320px]">
              {metrics.map((metric, index) => (
                <div
                  key={index}
                  className="p-4 lg:p-6 rounded-2xl bg-muted/30 backdrop-blur-sm"
                >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Welcome to your AI powered business central room. I can
                      analyze your pipeline, draft contracts sequences, and
                      execute GHL workflows. What can I help you accomplish?
                    </p>
                    <Link to="/saintgpt">
