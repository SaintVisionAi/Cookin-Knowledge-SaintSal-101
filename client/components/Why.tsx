      ...
      <div className="relative z-10 py-24 bg-black/10 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {/* Patented Technology */}
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-black/20 to-black/10 backdrop-blur-sm border border-border/30 hover:border-[hsl(var(--gold))]/50 transition-all duration-300">
              <div className="mb-6">
            ...
            {/* Faith-Guided Innovation */}
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-black/20 to-black/10 backdrop-blur-sm border border-border/30 hover:border-cyan-400/50 transition-all duration-300">
              <div className="mb-6">
            ...
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-black/20 to-black/10 backdrop-blur-sm border border-border/30 hover:border-blue-400/50 transition-all duration-300">
              <div className="mb-6">
            ...
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-black/20 to-black/10 backdrop-blur-sm border border-border/30 hover:border-green-400/50 transition-all duration-300">
              <div className="mb-6">
            ...
            {/* Global Impact */}
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-black/20 to-black/10 backdrop-blur-sm border border-border/30 hover:border-purple-400/50 transition-all duration-300">
              <div className="mb-6">
            ...
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-black/20 to-black/10 backdrop-blur-sm border border-border/30 hover:border-orange-400/50 transition-all duration-300">
              <div className="mb-6">
          ...
          <div className="mb-20">
            ...
            <div className="bg-gradient-to-br from-black/20 to-black/10 backdrop-blur-sm rounded-2xl p-8 border border-border/30">
          ...
          {/* Call to Action */}
          <div className="text-center bg-gradient-to-br from-black/20 to-black/10 backdrop-blur-sm rounded-3xl p-12 border border-border/30">
